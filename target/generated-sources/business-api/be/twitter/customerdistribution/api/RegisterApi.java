...
public interface RegisterApi {
     ...
     */
    @ApiOperation(value = "", nickname = "userRegistration", notes = "Register as new user", response = String.class, tags={ "Registration and Login", })
    @ApiResponses(value = { 
    ...
    ResponseEntity<String> userRegistration(@ApiParam(value = "" ,required=true )  @Valid @RequestBody UserDetails userDetails);
